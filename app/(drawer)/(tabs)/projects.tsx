...
export default function ProjectsScreen() {
  ...
  const [selectedDate, setSelectedDate] = useState('Date modified');
    ...
    <ThemedView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.filterBar, { backgroundColor: colors.surface }]}>
        ...
        <View style={{ position: 'relative', flex: 1 }}>
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <ThemedText style={styles.dropdownSelectedTextSmall}>{selectedOwner}</ThemedText>
            <MaterialIcons name="arrow-drop-down" size={18} />
          </TouchableOpacity>
          {ownerDropdownVisible && (
            <View style={styles.dropdownMenu}>
              <TextInput
                style={styles.dropdownSearchSmall}
              ...
              {mockOwners
                ...
                .map(owner => (
                  ...
                  >
                    <ThemedText style={styles.dropdownItemTextSmall}>{owner.name}</ThemedText>
                  </TouchableOpacity>
                ))}
            </View>
          )}
        ...
        <View style={{ position: 'relative', flex: 1 }}>
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <ThemedText style={styles.dropdownSelectedTextSmall}>{selectedCategory}</ThemedText>
            <MaterialIcons name="arrow-drop-down" size={18} />
          </TouchableOpacity>
            ...
            <View style={styles.dropdownMenu}>
              ...
              {mockCategories
                ...
                .map(cat => (
                  ...
                  >
                    <ThemedText style={styles.dropdownItemTextSmall}>{cat}</ThemedText>
                  </TouchableOpacity>
                ))}
            </View>
          )}
        ...
        <View style={{ position: 'relative', flex: 1 }}>
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <ThemedText style={styles.dropdownSelectedTextSmall}>{selectedDate}</ThemedText>
            <MaterialIcons name="arrow-drop-down" size={18} />
          </TouchableOpacity>
          {dateDropdownVisible && (
            <View style={styles.dropdownMenu}>
              {mockDateOptions.map(option => (
                ...
                >
                  <ThemedText style={styles.dropdownItemTextSmall}>{option}</ThemedText>
        </TouchableOpacity>
              ))}
            </View>
          )}
      ...
      {selectedTab === 'All' && (
        <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
          ...
          <ThemedText style={[styles.sectionHeader, styles.recentHeader, { color: colors.text }]}>Recent designs</ThemedText>
          <View style={styles.recentGrid}>
            {designs.map(item => (
              <View key={item.id} style={styles.recentCardWrap}>
                <TouchableOpacity onPress={() => handleCardPress(item)} activeOpacity={0.85} style={styles.recentCard}>
                  <View style={styles.recentImageWrap}>
                    <ImageBackground
                      source={require('@/assets/images/projectimg.jpg')}
                      style={styles.recentImage}
                      imageStyle={styles.recentImageInner}
                      resizeMode="cover"
                    >
                      <TouchableOpacity style={styles.menuBtn}>
                        <MaterialIcons name="more-vert" size={22} color="#6366F1" />
                      </TouchableOpacity>
                    </ImageBackground>
                  </View>
                  <View style={styles.recentCardContent}>
                    <ThemedText style={[styles.recentTitle, { color: colors.text }]}>{item.title}</ThemedText>
                    <ThemedText style={styles.recentMeta}>{item.category}  •  {item.lastModified}</ThemedText>
                  </View>
                </TouchableOpacity>
              </View>
            ))}
          ...
          {/* Folders */}
          <ThemedText style={[styles.sectionHeader, styles.recentHeader, { color: colors.text }]}>Folders</ThemedText>
          <View style={styles.recentGrid}>
            {mockFolders.map(folder => (
              <View key={folder.id} style={styles.recentCardWrap}>
                <TouchableOpacity onPress={() => handleCardPress(folder)} activeOpacity={0.85} style={styles.recentCard}>
                  <View style={styles.recentImageWrap}>
                    <MaterialIcons name="cloud-upload" size={40} color="#6366F1" style={{ alignSelf: 'center', marginTop: 30 }} />
                  </View>
                  <View style={styles.recentCardContent}>
                    <ThemedText style={[styles.recentTitle, { color: colors.text }]}>{folder.name}</ThemedText>
                  </View>
                </TouchableOpacity>
              </View>
            ))}
          ...
          {/* Designs */}
          <ThemedText style={[styles.sectionHeader, styles.recentHeader, { color: colors.text }]}>Designs</ThemedText>
          <View style={styles.recentGrid}>
            {designs.map(item => (
              <View key={item.id} style={styles.recentCardWrap}>
                <TouchableOpacity onPress={() => handleCardPress(item)} activeOpacity={0.85} style={styles.recentCard}>
          ...
          {/* Images */}
          <ThemedText style={[styles.sectionHeader, styles.recentHeader, { color: colors.text }]}>Images</ThemedText>
          <View style={styles.recentGrid}>
            {mockImages.map(item => (
              <View key={item.id} style={styles.recentCardWrap}>
                <TouchableOpacity onPress={() => handleCardPress(item)} activeOpacity={0.85} style={styles.recentCard}>
